...
const LocationDetailsPage = () => {
  ...
  const handleReserve = async () => {
    ...
    try {
      ...
      alert("Failed to make reservation. Try again!");
    }
  };
  ...
  return (
    <>
      ...
      <div className="listings-section">
        <div className="listings-header" key={listing._id}>
          <p>{listing.title}</p>
        ...
        <div className="listings-image-container">
          ...
          <div className="small-img-container">
            <div className="small-img-row1">
              <img src={listing.images[1]} alt="listing-img" />
              <img
            ...
            <div className="small-img-row2">
              <img src={listing.images[3]} alt="listing-img" />
          ...
          <div className="listing-details-left">
                    ...
                    badgeContent={
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M15.1865 1.30513C15.1865 0.977508 14.9209 0.711914 14.5933 0.711914H1.30513C0.977508 0.711914 0.711914 0.977508 0.711914 1.30513V11.5801C0.711914 11.7599 0.793457 11.93 0.933629 12.0426L7.57769 17.3796C7.79469 17.5539 8.10371 17.5539 8.32071 17.3796L14.9648 12.0426C15.1049 11.93 15.1865 11.7599 15.1865 11.5801V1.30513Z"
                          fill="white"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M1.30508 0H14.5932C15.314 0 15.8983 0.584306 15.8983 1.30508V11.58C15.8983 11.9756 15.7189 12.3498 15.4105 12.5975L8.76646 17.9345C8.28906 18.318 7.60924 18.318 7.13184 17.9345L0.487773 12.5975C0.179394 12.3498 0 11.9756 0 11.58V1.30508C0 0.584306 0.584306 0 1.30508 0ZM14.5932 0.711864C14.9208 0.711864 15.1864 0.977458 15.1864 1.30508V11.58C15.1864 11.7598 15.1049 11.9299 14.9647 12.0425L8.32066 17.3795C8.10366 17.5539 7.79465 17.5539 7.57765 17.3795L0.93358 12.0425C0.793407 11.9299 0.711864 11.7598 0.711864 11.58V1.30508C0.711864 0.977458 0.977458 0.711864 1.30508 0.711864H14.5932Z"
                          fill="black"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M1.42411 11.5252L14.3804 1.54248V11.5252L14.3802 11.5252L7.90204 16.7289L1.42391 11.5252H1.42411Z"
                          fill="#F5BF41"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M14.3803 11.5252L1.42407 1.54248V11.5252L1.42416 11.5252L7.90228 16.7289L14.3804 11.5252H14.3803Z"
                          fill="#DE3151"
                        />
                        <path
                          d="M11.5085 23.7288C11.5085 25.6945 9.91497 27.2881 7.94921 27.2881C5.98346 27.2881 4.38989 25.6945 4.38989 23.7288C4.38989 21.763 5.98346 20.1694 7.94921 20.1694C9.91497 20.1694 11.5085 21.763 11.5085 23.7288Z"
                          fill="white"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M12.2204 23.7287C12.2204 26.0876 10.3081 27.9999 7.94917 27.9999C5.59025 27.9999 3.67798 26.0876 3.67798 23.7287C3.67798 21.3698 5.59025 19.4575 7.94917 19.4575C10.3081 19.4575 12.2204 21.3698 12.2204 23.7287ZM7.94917 27.288C9.91493 27.288 11.5085 25.6945 11.5085 23.7287C11.5085 21.7629 9.91493 20.1694 7.94917 20.1694C5.98341 20.1694 4.38984 21.7629 4.38984 23.7287C4.38984 25.6945 5.98341 27.288 7.94917 27.288Z"
                          fill="black"
                        />
                        <path
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M6.31535 21.2529C5.51265 21.7837 4.98315 22.6944 4.98315 23.7288C4.98315 25.367 6.31112 26.6949 7.94926 26.6949C9.24148 26.6949 10.3407 25.8686 10.7473 24.7155L6.31535 21.2529Z"
                          fill="#F5BF41"
                        />
                      </svg>
                    }
            ...
            <div className="listing-info-container">
              ...
              <div className="listing-info-row">
                <div className="listing-info-icon">
                  ...
                  >
                    <path
                      d="M20 6.33325C20 10.0151 18.0153 13.3333 14.3334 13.3333C18.0153 13.3333 20 16.6514 20 20.3333C20 16.6514 21.9848 13.3333 25.6667 13.3333C21.9848 13.3333 20 10.0151 20 6.33325Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M10.6667 16.9999C10.6667 19.2091 8.54251 21.3333 6.33337 21.3333C8.54251 21.3333 10.6667 23.4574 10.6667 25.6666C10.6667 23.4574 12.7909 21.3333 15 21.3333C12.7909 21.3333 10.6667 19.2091 10.6667 16.9999Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="listing-info-row">
                <div className="listing-info-icon">
                  ...
                  >
                    <path
                      d="M20.3333 6.33325H11.6667C10.1939 6.33325 9 7.52716 9 8.99992V25.6666H23V8.99992C23 7.52716 21.8061 6.33325 20.3333 6.33325Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M19.3333 15.9999C19.3333 16.3681 19.0349 16.6666 18.6667 16.6666C18.2985 16.6666 18 16.3681 18 15.9999C18 15.6317 18.2985 15.3333 18.6667 15.3333C19.0349 15.3333 19.3333 15.6317 19.3333 15.9999Z"
                      stroke="black"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M6.33337 25.6667H25.6667"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="listing-info-row">
                <div className="listing-info-icon">
                  ...
                  >
                    <path
                      d="M6.33337 11.6667C6.33337 10.1939 7.52728 9 9.00004 9H23C24.4728 9 25.6667 10.1939 25.6667 11.6667V23C25.6667 24.4728 24.4728 25.6667 23 25.6667H9.00004C7.52728 25.6667 6.33337 24.4728 6.33337 23V11.6667Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <div className="listing-info-titlesub cal-align">
                  <p className="info-title">Free cancellation before Aug 14</p>
            ...
            <div className="listing-bedroom-container">
              ...
              <div className="bedroom-info">
                <img src={listing.images[1]} alt="bedroom" />
                ...
                <div className="amenities-column">
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M6.33337 17.3334C6.33337 9.86671 25.6667 6.33337 25.6667 6.33337C25.6667 6.33337 24.3334 25.6667 16 25.6667C10.6667 25.6667 6.33337 22.6667 6.33337 17.3334Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M6.33337 25.6666C6.33337 25.6666 10.6667 18.6666 16.3334 15.6666"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M16.6667 24C16.6667 24.3682 16.3682 24.6667 16 24.6667C15.6319 24.6667 15.3334 24.3682 15.3334 24C15.3334 23.6319 15.6319 23.3334 16 23.3334C16.3682 23.3334 16.6667 23.6319 16.6667 24Z"
                          stroke="black"
                        />
                        <path
                          d="M12.6666 19.417C13.602 18.7355 14.754 18.3334 16 18.3334C17.2459 18.3334 18.3979 18.7355 19.3333 19.417"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        ...
                        />
                        <path
                          d="M6.66663 10.5942C9.31224 8.74886 12.5297 7.66663 16 7.66663C19.4702 7.66663 22.6877 8.74886 25.3333 10.5942"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M25.6667 16C25.6667 21.3388 21.3388 25.6667 16 25.6667C10.6613 25.6667 6.33337 21.3388 6.33337 16C6.33337 10.6613 10.6613 6.33337 16 6.33337C21.3388 6.33337 25.6667 10.6613 25.6667 16Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M14.3334 9.66671H23C24.4728 9.66671 25.6667 8.4728 25.6667 7.00004V6.33337"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        ...
                        />
                        <path
                          d="M18.3334 22.3334H23C24.4728 22.3334 25.6667 23.5273 25.6667 25V25.6667"
                          stroke="#141414"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M21.6669 25.6666H10.3333C8.86053 25.6666 7.66663 24.4727 7.66663 23V13.3333L16.0001 7.66663L24.3336 13.3333V23C24.3336 24.4727 23.1397 25.6666 21.6669 25.6666Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                ...
                <div className="amenities-column">
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M6.33325 9.00004C6.33325 7.52728 7.52716 6.33337 8.99992 6.33337H22.9999C24.4727 6.33337 25.6666 7.52728 25.6666 9.00004V21.6667C25.6666 23.1395 24.4727 24.3334 22.9999 24.3334H8.99992C7.52716 24.3334 6.33325 23.1395 6.33325 21.6667V9.00004Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        ...
                        />
                        <path
                          d="M12.3333 10.3334L10.3333 12.3334"
                          stroke="#141414"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M17.6666 10.3334L10.3333 17.6667"
                          stroke="#141414"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M24.3333 18.6667C24.3333 24 20.6667 25.6667 16 25.6667C10.6667 25.6667 7.66675 21.8667 7.66675 18.6667C7.66675 15.4667 9.33341 12.5556 10.6667 11.6667C10.6667 15.4 14.2223 17.7778 16 17.6667C12.8 12.8667 15.5556 7.5556 17.3333 6.33337C17.3333 12.3334 24.3333 13.3334 24.3333 18.6667Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        <path
                          d="M20.6666 13.3333L25.6666 10.3333V21.6667L20.6666 18.6667M8.99992 23H17.6666C19.1393 23 20.3333 21.8061 20.3333 20.3333V11.6667C20.3333 10.1939 19.1393 9 17.6666 9H8.99992C7.52716 9 6.33325 10.1939 6.33325 11.6667V20.3333C6.33325 21.8061 7.52716 23 8.99992 23Z"
                          stroke="black"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                  ...
                  <div className="amenity-row">
                    <div className="amenity-icon">
                      ...
                      >
                        ...
                        />
                        <path
                          d="M21.3334 14.6666L19.6667 7.66663H25.3334"
                          stroke="#141414"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M12.6666 17.3333H16.3333M16.3333 17.3333L11.6666 10.3333H13.9999H9.33325M16.3333 17.3333H19.3333"
                          stroke="#141414"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
              ...
              <div className="calender-titlesub">
                <p className="calendar-title">
                  {nights > 0
                    ...
                    : `Select dates for ${listing.location}`}
                </p>
            ...
            <div className="booking-box-container">
              <div className="booking-box-header">
                <div className="booking-price">
                  <p className="price-bold">R{listing.price}</p>
                  <p>/</p>
                  <p>night</p>
                </div>
                <div className="booking-rating">
                  ...
                  <p>&bull;</p>
                  <p className="booking-review">{listing.reviews} reviews</p>
                </div>
              </div>
              <div className="guest-dates">
                <div className="guest-inout">
                  <div className="guest-in">
                    ...
                    <p className="value">{formattedCheckIn}</p>
                  </div>
                  <div className="guest-out">
                    <p className="attribute">CHECKOUT</p>
                    <p className="value">{formattedCheckOut}</p>
                  </div>
                </div>
                <div className="guest-number">
                  <div className="guest-details">
                    <p className="attribute">GUESTS</p>
                    <p className="value">{listing.guests} guests</p>
                  </div>
              ...
              <p className="charge-disclaimer">You won’t be charged yet</p>
              <div className="guest-price-details">
                <div className="guest-price-row">
                  <p className="guest-price-item">
                    R{listing.price} x {nights} nights
                  </p>
                  <p className="guest-price-value">R{listing.price * nights}</p>
                </div>
                <div className="guest-price-row">
                  <p className="guest-price-item">Weekly discount</p>
                  <p className="guest-price-value green">
                    -R{listing.weeklyDiscount}
                  </p>
                </div>
                <div className="guest-price-row">
                  <p className="guest-price-item">Cleaning fee</p>
                  <p className="guest-price-value">R{listing.cleaningFee}</p>
                </div>
                <div className="guest-price-row">
                  <p className="guest-price-item">Service fee</p>
                  <p className="guest-price-value">R{listing.serviceFee}</p>
                </div>
                <div className="guest-price-row">
                  <p className="guest-price-item">Occupancy taxes and fees</p>
                  <p className="guest-price-value">R{listing.occupancyTaxes}</p>
                </div>
              </div>
              <div className="guest-price-total">
                <p className="guest-price-total-title">Total</p>
                <p className="guest-price-total-value">
                  R
              ...
              <div className="review-category-row">
                ...
                <div className="review-rating-bar">
                  ...
                  <div className="review-rating">
                    <p>{listing.specifics.cleanliness}</p>
                  </div>
                </div>
              </div>
              <div className="review-category-row">
                ...
                <div className="review-rating-bar">
                  ...
                  <div className="review-rating">
                    <p>{listing.specifics.communication}</p>
                  </div>
                </div>
              </div>
              <div className="review-category-row">
            ...
            <div className="review-ratings-column">
              <div className="review-category-row">
                ...
                <div className="review-rating-bar">
                  ...
                  <div className="review-rating">
                    <p>{listing.specifics.accuracy}</p>
                  </div>
                </div>
              </div>
              <div className="review-category-row">
                ...
                <div className="review-rating-bar">
                  ...
                  <div className="review-rating">
                    <p>{listing.specifics.location}</p>
                  </div>
                </div>
              </div>
              <div className="review-category-row">
          ...
          <div className="review-comments-container">
            <div className="review-comments-row">
              <div className="review-comment">
                ...
                <p className="user-comment">Host was very attentive.</p>
              </div>
              <div className="review-comment">
                <div className="review-user-profile">
                  <div className="review-user-avatar">
            ...
            <div className="review-comments-row">
              ...
              <div className="review-comment">
                ...
                <p className="user-comment">Nice place to stay!</p>
              </div>
            </div>
            <div className="review-comments-row">
              <div className="review-comment">
                ...
                <p className="user-comment">Well designed and fun space</p>
              </div>
              <div className="review-comment">
                <div className="review-user-profile">
                  <div className="review-user-avatar">
          ...
          <div className="about-host-header">
            <div className="about-host-details">
              ...
              <div className="about-host-titlesub">
                <p className="about-host-title">Hosted by {listing.host}</p>
            ...
            <div className="about-host-description">
              <p className="description-dark">{listing.host} is a superhost.</p>
            ...
            <div className="about-host-contact">
              <button className="about-host-contact-btn">Contact Host</button>
            </div>
          ...
          <div className="things-to-know-columns">
            <div className="things-to-know-column">
              ...
              <div className="things-to-know-list-item">
                ...
                <div className="things-to-know-text">No smoking</div>
              </div>
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  <svg
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M9.50006 17.6367C8.90326 17.2553 8.27352 16.707 7.68044 16.0227C7.28988 15.5721 6.95046 15.1031 6.6698 14.6387"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    />
                    <path
                      d="M17 13L17.2929 12.7071C17.6834 12.3166 18.3166 12.3166 18.7071 12.7071L19 13"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
            ...
            <div className="things-to-know-column">
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    <path
                      d="M17.3333 4.75C17.3333 5.89705 16.2303 7 15.0833 7C16.2303 7 17.3333 8.10295 17.3333 9.25C17.3333 8.10295 18.4362 7 19.5833 7C18.4362 7 17.3333 5.89705 17.3333 4.75Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M17.3333 14.75C17.3333 15.8971 16.2303 17 15.0833 17C16.2303 17 17.3333 18.1029 17.3333 19.25C17.3333 18.1029 18.4362 17 19.5833 17C18.4362 17 17.3333 15.8971 17.3333 14.75Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M9.33325 7.75C9.33325 9.91666 7.24991 12 5.08325 12C7.24991 12 9.33325 14.0833 9.33325 16.25C9.33325 14.0833 11.4166 12 13.5833 12C11.4166 12 9.33325 9.91666 9.33325 7.75Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    <path
                      d="M5.08325 19.25V15.75C5.08325 14.6454 5.97868 13.75 7.08325 13.75H13.5833C14.6878 13.75 15.5833 14.6454 15.5833 15.75V19.25"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M7.08325 13.5L8.08325 10.75H12.5833L13.5833 13.5"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M10.3333 10.5V8.25M10.3333 8.25H9.08325V5.75H11.5833V8.25H10.3333Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    <path
                      d="M11.0833 7.25H17.5833C18.6878 7.25 19.5833 6.35457 19.5833 5.25V4.75"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    ...
                    />
                    <path
                      d="M14.0833 16.75H17.5833C18.6878 16.75 19.5833 17.6454 19.5833 18.75V19.25"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    <path
                      d="M14.5833 12C14.5833 13.2426 13.5759 14.25 12.3333 14.25C11.0906 14.25 10.0833 13.2426 10.0833 12C10.0833 10.7574 11.0906 9.75 12.3333 9.75C13.5759 9.75 14.5833 10.7574 14.5833 12Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                    />
                    <path
                      d="M19.5833 12C19.5833 16.0041 16.3373 19.25 12.3333 19.25C8.32919 19.25 5.08325 16.0041 5.08325 12C5.08325 7.99594 8.32919 4.75 12.3333 4.75C16.3373 4.75 19.5833 7.99594 19.5833 12Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
              ...
              <div className="things-to-know-list-item">
                <div className="things-to-know-icon">
                  ...
                  >
                    <path
                      d="M5.08325 7.75C5.08325 6.64543 5.97868 5.75 7.08325 5.75H17.5833C18.6878 5.75 19.5833 6.64543 19.5833 7.75V16.25C19.5833 17.3546 18.6878 18.25 17.5833 18.25H7.08325C5.97868 18.25 5.08325 17.3546 5.08325 16.25V7.75Z"
                      stroke="black"
                      strokeWidth="1.5"
                      strokeLinecap="round"
                      strokeLinejoin="round"
      ...
      <div className="explore-footer-container">
        <div className="explore-footer-title">
          <p>Explore other options in and around Cape Town</p>
        </div>
